...
using namespace std; using namespace opendnp3; namespace asiodnp3 { void MySOEHandler::Process(const HeaderInfo& info, const 
...
void MySOEHandler::Process(const HeaderInfo& /*info*/, const ICollection<Indexed<TimeAndInterval>>& values) {
...
void MySOEHandler::Process(const HeaderInfo& /*info*/, const ICollection<Indexed<BinaryCommandEvent>>& values) {
...
void MySOEHandler::Process(const HeaderInfo& /*info*/, const ICollection<Indexed<AnalogCommandEvent>>& values) {
...
void MySOEHandler::Process(const HeaderInfo& /*info*/, const ICollection<Indexed<SecurityStat>>& values) {
...
void MySOEHandler::Process(const opendnp3::HeaderInfo& /*info*/,
